...
//    {
//        uint32_t arr = __HAL_TIM_GET_AUTORELOAD(htim);                  // Valor do Auto Reload (ARR)
//        uint32_t compare = __HAL_TIM_GET_COMPARE(htim, TIM_CHANNEL_1);    // Valor do Compare
//
//        // Calcula o tempo total (overflow) e o tempo do evento de comparação (em segundos)
//        float timerFreq = 10000.0f; // 10 kHz, obtido com: 84MHz/(Prescaler+1) = 84MHz/8400 = 10 kHz
//        float totalTime = arr / timerFreq;     // Tempo total do ciclo
//        float compareTime = compare / timerFreq; // Instante do evento de compare
//
//        // Imprime os valores
